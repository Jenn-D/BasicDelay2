...
void BasicDelayAudioProcessorEditor::resized()
{
    ...
    sliderDelayTime->setBounds (8, 64, 216, 48);
    sliderFeedback->setBounds (8, 176, 216, 32);
    labelDelayTime->setBounds (8, 40, 150, 32);
    labelFeedback->setBounds (8, 152, 150, 24);
...
<JUCER_COMPONENT documentType="Component" className="BasicDelayAudioProcessorEditor"
  ...
  <SLIDER name="delay time" id="c677caeaf71284ab" memberName="sliderDelayTime"
          virtualName="" explicitFocusOrder="0" pos="8 64 216 48" min="0.010000000000000000208"
          max="1" int="0" style="LinearHorizontal" textBoxPos="TextBoxLeft"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1"
          needsCallback="1"/>
  <SLIDER name="feedback" id="cbc8c2c921a473db" memberName="sliderFeedback"
          virtualName="" explicitFocusOrder="0" pos="8 176 216 32" min="0"
          max="0.94999999999999995559" int="0" style="LinearHorizontal"
          textBoxPos="TextBoxLeft" textBoxEditable="1" textBoxWidth="80"
          textBoxHeight="20" skewFactor="1" needsCallback="1"/>
  <LABEL name="" id="c1569c940a6a6e3e" memberName="labelDelayTime" virtualName=""
         explicitFocusOrder="0" pos="8 40 150 32" edTextCol="ff000000"
         edBkgCol="0" labelText="Delay time (seconds)" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="15" bold="0" italic="0" justification="33"/>
  <LABEL name="new label" id="24fa5edc0c0dcdf7" memberName="labelFeedback"
         virtualName="" explicitFocusOrder="0" pos="8 152 150 24" edTextCol="ff000000"
